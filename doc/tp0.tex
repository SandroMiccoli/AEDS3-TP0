...
Primeiro, foi criado um script, em Python, para gerar arquivos de entrada para o trabalho. Esse programa recebia como parâmetro o número de instâncias a ser criado e o número máximo de linhas e colunas que essas matrizes teriam. Posteriormente foi feito outro script para gerar um lotes de arquivos de entrada e já armazenar o tempo de processamento de cada um.
	...
	O primeiro teste realizado foi o seguinte: foi fixado o número de linhas e colunas das matrizes para 50. Ou seja, cada matriz tinha $2.500$ elementos, e as matrizes resultado tinham $6.250.000$ elementos cada uma. Na Figura \ref{instancias}, podemos ver que o tempo de processamento cresceu de uma maneira esperada.

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\textwidth]{graph_inst.png}
	\caption{Instâncias de 50 x 50}
	\label{instancias}
\end{figure}
